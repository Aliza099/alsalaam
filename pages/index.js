...
const Home = () => {
  return (
    <>
      ...
      <div className="h-screen  bg-[url('/bg2.jpg')] bg-no-repeat bg-cover mt-20">
        <h1 className="flex justify-center  text-white  font-medium text-5xl mt-10">
          {" "}
          Top Deals
        </h1>
      </div>
      <div>
        ...
        <div class="grid grid-cols-3 gap-4 px-10 ">
          ...
          <div class="bg-[url('/imgG2.jpg')]  rounded-lg "></div>
        </div>

        <div class="grid grid-cols-3 gap-4 px-10 py-5 ">
          <div className=" bg-[url('/imgG3.jpg')] h-96 w-96 bg-cover rounded-lg bg-no-repeat "></div>
          <div class="bg-[url('/imgG4.jpg')] h-96 w-96 bg-cover rounded-lg bg-no-repeat "></div>
          <div class="bg-[url('/imgG5.jpg')] h-96  rounded-lg bg-cover rounded-lg bg-no-repeat  "></div>
        </div>
      </div>
    </>
  );
